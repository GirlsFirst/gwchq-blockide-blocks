...
Blockly.Options = function(options) {
  ...
  if (options['colours'] !== undefined) {
    if (options['colours']['NOTCH_PATH_LEFT']) {
      Blockly.BlockSvg.NOTCH_PATH_LEFT = options['colours']['NOTCH_PATH_LEFT'];
    }

    if (options['colours']['NOTCH_PATH_RIGHT']) {
      Blockly.BlockSvg.NOTCH_PATH_RIGHT = options['colours']['NOTCH_PATH_RIGHT'];
    }
  }
