...
Blockly.FieldDropdown.prototype.init = function() {
  ...
  const svgPath = !this.sourceBlock_.getCategory()
    ? Blockly.mainWorkspace.options.pathToMedia
    : Blockly.mainWorkspace.options.pathToMedia + '/' + this.sourceBlock_.getCategory() + '/';

  this.arrow_.setAttributeNS('http://www.w3.org/1999/xlink',
      'xlink:href', svgPath + 'dropdown-arrow.svg');
