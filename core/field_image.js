...
Blockly.FieldImage.prototype.init = function() {
  ...
  const svgName = this.src_.replace(Blockly.mainWorkspace.options.pathToMedia, '');
  const svgNewUrl = Blockly.mainWorkspace.options.pathToMedia + '/' + this.sourceBlock_.getCategory() + '/'+ svgName;
