...
Blockly.Block.prototype.setColourConfiguration = function(data) {
  const {primary, secondary, tertiary, quaternary, controlsColor} = data;

  if (controlsColor !== undefined) {
    this.colorControls_ = this.makeColour_(controlsColor);
  } else {
    this.colorControls_ = this.colour_;
  }
 ...
 *     contains string table references.
 * @param {string|?} controlsColor Quaternary colour, which may be a string that
 *     contains string table references.
 * @private
 */
Blockly.Block.prototype.setColourFromRawValues_ = function(primary, secondary,
    tertiary, quaternary, controlsColor) {
  ...
  controlsColor = goog.isString(controlsColor) ?
      Blockly.utils.replaceMessageReferences(controlsColor) : controlsColor;

  this.setColourConfiguration({primary, secondary, tertiary, quaternary, controlsColor});
};
