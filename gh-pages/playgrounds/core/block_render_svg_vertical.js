...
Blockly.BlockSvg.prototype.updateColour = function() {
  ...
  if (this.isGlowingBlock_ || renderShadowed) {
    ...
    if (this.getShadowColour()) {
      ...
      if (this.parentBlock_ && this.parentBlock_.type === "procedures_call" && ['text', 'math_number', 'boolean'].includes(this.type))
      {
        fillColour = this.parentBlock_.colourQuaternary_;
      }
      else if (this.parentBlock_ && this.parentBlock_.type === "procedures_declaration" && ['argument_editor_boolean', 'argument_editor_string_number'].includes(this.type))
      {
        fillColour = this.parentBlock_.colourQuaternary_;
      }
        ...
        [
          ...
          'event_broadcast_menu', 'control_create_clone_of_menu', 'sensing_touchingobjectmenu',
          'sensing_distancetomenu', 'sensing_keyoptions', 'sensing_of_object_menu'
        ].includes(this.type)) {
        fillColour = this.parentBlock_.colorControls_;
      }
    }
  } else {
